...
<body>
    ...
    <div>
        ...
        <button class="bg-[#0A1E61] text-white p-2 flex items-center mt-2 mb-[0.5%] ml-1" onclick="downloadnotShippedDataCSV()">
            <span class="material-symbols-outlined pb-0 text-lg">description</span>
            <span class="ml-2">EXPORT TO EXCEL</span>
        </button>

        <table class="table border-collapse border border-slate-500 ml-1 mr-1 mb-3" id="notShippedData">
            <thead>
                <tr>
