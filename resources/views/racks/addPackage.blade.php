    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- Form start --}}
                    <form method="POST" action="{{ route('add-package')}}">
                        @csrf

                        <div class="row mb-3">
                            <label for="packets-name" class="col-md-4 col-form-label text-md-end"
                                style="color:#0A1E61;">Package Name</label>

                            <div class="col-md-6">
                                <input id="packageName" type="text" class="form-control" name="packageName"
                                    value="{{ old('packageName') }}" required autofocus>

                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="product-manager" class="col-md-4 col-form-label text-md-end" style="color:#0A1E61;">PM</label>

                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="pm" value="{{ old('pm') }}"
                                    required >
                        ...
                        <div class="row mb-3">
                            <label for="purchasing-agent" class="col-md-4 col-form-label text-md-end"
                                style="color:#0A1E61;">Purchasing Agent</label>

                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="purchasingAgent" required value="{{ old('purchasingAgent') }}">

                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="date-in" class="col-md-4 col-form-label text-md-end"
                                style="color:#0A1E61;">Data In</label>
                        ...
                        <div class="row mb-3">
                            <label for="fate-out" class="col-md-4 col-form-label text-md-end"
                                style="color:#0A1E61;">Expected Date Out</label>

                                <div class="col-md-6">
                                    <input id="expectedDateOut" type="date" class="form-control" name="expectedDateOut" required
                                    value="{{ old('expectedDateOut') }}" >
                                </div>
                        </div>
