    ...
    <ul class="links">
        ...
        @if(auth()->check() && auth()->user()->designation == 'Admin')
            <li>
                ...
                <a class="btn_text" href="{{ route('registerUser') }}">Register User</a>
            </li>
        @endif
       ...
       document.getElementById('logout-form').submit();">
            ...
            <a class="btn_text" href="{{ route('logout') }}">Logout</a>
