...
{{-- @dd($branchID); --}}
   ...
   <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header" style="font-weight:600 ; text-align:center; font-size: 120%; color:#091F62;">Add
                        New Location</div>

                    <div class="card-body">
                        {{-- THIS FORM ADD NEW LOCATION ON DATABASE  --}}
                        <form method="POST" action="{{ route('location') }}?branchID={{ $branchID }}"> {{--  FORM START --}}
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="locationName" type="text" class="form-control" name="locationName" value=""
                                        required autocomplete="locationName" autofocus>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button class="button" data-id="{{ $branchID }}"> Add</button>
                                </div>
                            </div>
                        </form> {{--  FORM END --}}
                    </div>
